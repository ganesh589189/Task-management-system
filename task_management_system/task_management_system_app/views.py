...
def user_tasks_list(request):
    ...
    return render(request, 'task_management_system_app/user_task_list.html', {'tasks': tasks})
...
def update_task(request, task_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('category_list')  # Redirect to your desired URL after successful update
    else:
        form = TaskForm(instance=task)

    return render(request, 'task_management_system_app/update_task.html', {'form': form})
@login_required
@admin_required
...
def dashboard(request):
    return render(request,'task_management_system_app/dashboard.html')
def about(request):
    return render(request,'task_management_system_app/about.html')
def contact(request):
    return render(request,'task_management_system_app/contact.html')
def faq(request):
    return render(request,'task_management_system_app/faq.html')